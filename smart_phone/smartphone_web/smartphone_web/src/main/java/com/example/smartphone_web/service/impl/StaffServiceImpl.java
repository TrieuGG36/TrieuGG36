...
import com.example.smartphone_web.dto.request.staff.StaffAddRequestDTO;
import com.example.smartphone_web.dto.request.staff.StaffEditRequestDTO;
import com.example.smartphone_web.dto.respone.staff.StaffResponeDto;
import com.example.smartphone_web.entity.StaffEntity;
import com.example.smartphone_web.exception.SmartPhoneExp;
import com.example.smartphone_web.repository.StaffRepo;
import com.example.smartphone_web.service.IStaffService;
...
public class StaffServiceImpl implements IStaffService {
    ...
    public String addStaff(StaffAddRequestDTO staff) {
        ...
        if (staffRepo.findByEmailAndDeleteFlagIsFalse(staff.getEmail()).size() != 0) {
            throw new SmartPhoneExp(ConstansErrorCode.STAFF_EMAIL);
        }
    ...
    public String changePass(Long id, String oldPass, String newPass) {
        ...
        if(!pass.matches(oldPass, entity.getPassword())){
            return new SmartPhoneExp(ConstansErrorCode.STAFF_NOT_MATCHES_PASS).getErrorMessage().getVn();
        }
